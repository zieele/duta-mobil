...
@section('content')
  <main class="bg-gray-100 bg-opacity-50 w-full my-16 sm:max-w-xl lg:max-w-4xl flex items-center flex-col rounded-t-xl">
    ...
    <div class="flex w-full justify-between">
      ...
      <h1 class="w-4/12 text-center text-2xl text-gray-800 font-bold tracking-wide uppercase my-4">Customers List</h1>
      ...
      <table class="table-fixed bg-white rounded-xl shadow-lg text-gray-800 sm:w-11/12 mb-4" style="width: 52rem;">
        <thead class="border-b-2">
          <tr>
            ...
            <th style="width: 19%">KTP</th>
            <th style="width: 25%">Name</th>
            <th style="width: 27%">Address</th>
            <th style="width: 18%">Phone No.</th>
            <th style="width: 6%"></th>
          </tr>
        </thead>
        <tbody>
          ...
          ">
            ...
            <td class="text-center">
              <ul>
                <li class="my-1">
                  <button id="showEdit{{ $item->ktp }}" type="button" class="w-10 h-10 duration-100 text-white bg-green-400 rounded-lg hover:text-green-400 hover:bg-opacity-20">
                    <i class="fas fa-edit"></i>
                  </button>
                </li>
                <li class="my-1"><button id="showDelete{{ $item->ktp }}" type="button" class="w-10 h-10 duration-100 text-white bg-red-400 rounded-lg hover:text-red-400 hover:bg-opacity-20"><i class="fas fa-trash-alt"></i></button></li>
              </ul>
            </td>
          </tr>
          @php
